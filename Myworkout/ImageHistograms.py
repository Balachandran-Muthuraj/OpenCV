...
def draw_image_histogram_bgr(image, title='', yscale='linear'):
    ...
    draw_image_histogram_bgr(img1985, '1985')
    draw_image_histogram_bgr(img2011, '2011')
    draw_image_histogram_bgr(img1985, '1985 - Log Plot', 'log')
    draw_image_histogram_bgr(img2011, '2011 - Log Plot', 'log')